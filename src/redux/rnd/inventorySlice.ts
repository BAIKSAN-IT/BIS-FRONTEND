...
export interface RndArticleInventoryAllRes {
  rndArticleInventoryList: RndArticleInventoryRes[];
  rndArticleFileList: RndArticleFileRes[];
}

export interface RndArticleInventoryReq {
  cdCompany?: string;
  seqArticle?: string;
  nmFabric?: string;
  cdHanger?: string;
...
export interface RndArticleInventoryRes {
  // RD_ARTICLE (B.*)
  cdCompany?: string;
  seqArticle?: string;
  cdHanger?: string;
...
export const getRndArticleInventoryAllList = createAsyncThunk<AxiosResponse, RndArticleInventoryReq>(
