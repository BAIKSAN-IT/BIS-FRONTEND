...
export interface KnittingGaugeSummaryTableRow {
  key: string;
  label: string;
...
interface Props {
  rows: KnittingGaugeSummaryTableRow[];
...
const KnittingGaugeSummaryTable = memo(
...
export default KnittingGaugeSummaryTable;
