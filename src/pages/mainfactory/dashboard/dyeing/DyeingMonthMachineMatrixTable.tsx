...
import {DyeingMachineDef} from "@pages/mainfactory/dashboard/dyeing/DyeingMachineRateChart";
import {
...
interface Props {
  ...
  machineDefs: Pick<DyeingMachineDef, "key" | "label" | "color">[];
}
...
const DyeingMonthMachineMatrixTable = memo(
...
export default DyeingMonthMachineMatrixTable;
