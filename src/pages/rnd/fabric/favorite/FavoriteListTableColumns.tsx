...
const FavoriteListTableColumns = (fileList?: SaveRndArticleFileReq[]) => {
      ...
      columns: [
        ...
        },
        {
          ...
          Cell: ({ value }: any) => (
            <div
              style={{
                backgroundColor: "#EDF2FB", // 밝은 파랑 배경
                color: "#2A4365", // 진한 남색 글씨
...
export default FavoriteListTableColumns;
