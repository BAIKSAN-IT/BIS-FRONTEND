...
import {getCuttingActual} from "@redux/eis/dashboard/CuttingSlice";

import {CUTTING_STYLE_COLUMNS, CUTTING_STYLE_COLUMNS_TYPE} from "@constants/eis/dashboard/cuttingActual";
...
const CuttingActual = forwardRef((props: HEADER_PROPS, ref) => {
  ...
  useEffect(() => {
    ...
    dispatch(getCuttingActual(sparams)).then((res) => {
  ...
  const handleSearch = (val: any) => {
    ...
    dispatch(getCuttingActual(params)).then((res) => {
      const payload = res.payload as Payload;
