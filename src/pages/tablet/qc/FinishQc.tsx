...
import {
  getQcActualQrInfo,
  getQcActualQrList,
  getTodayQcActualQrList,
  deleteQrListInfo,
  saveQrListInfo,
} from "../../../redux/tablet/tabletQcSlice";
import {
  QR_COLUMNS,
  PASS_COLUMNS,
  REJECT_COLUMNS,
  ...
  PassItems,
  RejectItems,
} from "../../../constants/tablet/qc/finishQc";
...
const FinishQc = forwardRef((props: HEADER_PROPS, ref) => {
  ...
  const getQrList = (qrInfo?: any) => {
    if (
      ...
      dispatch(getQcActualQrList(params)).then((res) => {
        const payload = res.payload as Payload;
  ...
  const getTodayQrList = () => {
    ...
    dispatch(getTodayQcActualQrList(params)).then((res) => {
      const payload = res.payload as Payload;
  ...
  const handleSearch = (val: any) => {
    if (val) {
      ...
      dispatch(getQcActualQrInfo(params)).then((res) => {
        const payload = res.payload as Payload;
