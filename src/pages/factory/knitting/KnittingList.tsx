...
import { getKnittingStatus } from "../../../redux/factory/factoryKnittingSlice";
import { Payload } from "../../../constants/common/common";
import { HEADER_PROPS } from "../../../constants/common/common";
import {
  KNITTING_COLUMNS_TYPE,
...
const KnittingList = forwardRef((props: HEADER_PROPS, ref) => {
          ...
          >
            <div className="item-header">
              ...
              <div className="item-icon">
                <img
                  src={
                    item.deviceOperatingStatus === "0" ||
                    item.deviceOperatingStatus === "2"
                      ? knittingState3
                      : item.status === "1"
                      ? knittingState1
                      : knittingState2
