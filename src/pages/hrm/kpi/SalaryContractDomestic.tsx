...
// invoice component
const SalaryContractDomestic = ({ salaryAmt }: Props) => {
                    ...
                    <div className="table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td style={{ border: "1px solid #ccc", padding: "4px" }}>식대교통비</td>
                            <td style={{ border: "1px solid #ccc", padding: "4px" }}>
                              {salaryAmt?.amtFood ? Number(salaryAmt.amtFood).toLocaleString() : "0"}
                            </td>
                            <td style={{ border: "1px solid #ccc", padding: "4px" }}>
                              {salaryAmt?.amtFoodYear ? Number(salaryAmt.amtFoodYear).toLocaleString() : "0"}
                            </td>
                            <td style={{ border: "1px solid #ccc", padding: "4px" }}></td>
                          </tr>
                        </tbody>
                      ...
                      <table>
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td
                              style={{ position: "relative", width: "100%", height: "100%", border: "0px solid #ccc" }}
                            >
                              <span>서명 또는 인</span>
                              <span
                                style={{
...
export default SalaryContractDomestic;
