...
const SrsHeader = ({ activeTab, onTabChange }: SrsHeaderProps) => {
  ...
  return (
    <header className="srs-topbar">
      ...
      <nav className="srs-tabs" aria-label="SRS 메뉴">
        ...
        <div className="srs-user-panel srs-tabs-user-panel">
          ...
          <button type="button" className="srs-back-button" onClick={() => navigate("/", { replace: true })}>
            PIS 홈
          </button>
        </div>
      </nav>
