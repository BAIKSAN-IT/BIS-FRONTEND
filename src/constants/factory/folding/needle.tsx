...
export const NEEDLE_COLUMNS = [
  ...
  },
  {
    ...
    className: "text-center",
    Cell: ({ row }: { row: any }) => (
      <CommaColumn row={row} columnName="clrFin" />
    ),
  },
  {
    Header: () => <TitleEnterCell header="FIN<br/>QTY" />,
    accessor: "qtFin",
    className: "text-center",
    Cell: ({ row }: { row: any }) => (
      <CommaColumn row={row} columnName="qtFin" />
    ),
  },
  {
  ...
  {
    Header: () => <TitleEnterCell header="TTL_CLR<br/>FIN" />,
    accessor: "ttlClrfin",
    className: "text-center",
    Cell: ({ row }: { row: any }) => (
      <CommaColumn row={row} columnName="ttlClrfin" />
    ),
  },
  {
    Header: () => <TitleEnterCell header="TTL<br/>FIN" />,
    accessor: "ttlFin",
    className: "text-center",
    Cell: ({ row }: { row: any }) => (
      <CommaColumn row={row} columnName="ttlFin" />
    ),
  },
];

export interface NEEDLE_COLUMNS_TYPE {
  sw: string;
  seqStyle: string;
  nmBuyer: string;
  seqOrd: string;
